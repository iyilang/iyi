...
| iyi's own prelude | 14,208 lines, of which 3,734 are the library held to the 3,734 ceiling; the rest is the collector, the scheduler and the float printer, which 0.1.0's prelude got from libgc, pthreads and libc |
| compiler | 111,110 lines, none of it written in iyi |
...
> "No standard library worth the name" is still true of iyi's own 14,208 lines
...
**3. A deliberately tiny prelude, written in iyi. Done: 14,208 lines,
...
**3,734 lines** of the 14,208, measured by `bench/doc_numbers.py` as
...
|---|---|---|
| Compiler | 24,984 lines, **written in Crystal** | 111,110 lines, Crystal, forked |
| Library | 8,161 lines (3,551 of it core) | 14,208-line own prelude + 37,186 in std |
| Specs | 21,146 lines | 10,238 for iyi |
...
12. ~~**Using Crystal code.**~~ **Specified in III.6; the direct source mode
    ...
    **The Crystal ecosystem, and what a shard would cost.** Ten thousand
    ...
    Crystal's 8,161-line standard library against iyi's own 14,208-line prelude.
