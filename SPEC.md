...
| compiler | 112,679 lines, none of it written in iyi |
...
|---|---|---|
| Compiler | 24,984 lines, **written in Crystal** | 112,679 lines, Crystal, forked |
| Library | 8,161 lines (3,551 of it core) | 15,450-line own prelude + 38,914 in std |
| Specs | 21,146 lines | 10,614 for iyi |
