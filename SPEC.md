...
| iyi's own prelude | 16,149 lines, of which 3,400 are the library held to the 3,734 ceiling (4,908 with every platform's floor, which the ceiling stopped counting after Windows); the rest is the collector, the scheduler and the float printer, which 0.1.0's prelude got from libgc, pthreads and libc |
...
> "No standard library worth the name" is still true of iyi's own 16,149 lines
...
**3. A deliberately tiny prelude, written in iyi. Done: 16,149 lines,
primitives included, of which the library is 3,400.** Not a standard library:
...
**3,400 lines** of the 16,149, measured by `bench/doc_numbers.py` as
...
below settles and explains. Opening `src/iyi/` counts 4,908 with the floor
...
and the library is **3,400** of 3,734 with 334 to spare.
...
| Library | 8,161 lines (3,551 of it core) | 16,149-line own prelude + 39,210 in std |
...
12. ~~**Using Crystal code.**~~ **Specified in III.6; the direct source mode
    ...
    **The Crystal ecosystem, and what a shard would cost.** Ten thousand
    ...
    Crystal's 8,161-line standard library against iyi's own 16,149-line prelude.
