...
> "No standard library worth the name" is still true of iyi's own 17,489 lines
...
**3. A deliberately tiny prelude, written in iyi. Done: 17,489 lines,
...
below settles and explains. Opening `src/iyi/` counts 5,017 with the floor
...
| Library | 8,161 lines (3,551 of it core) | 17,489-line own prelude + 40,695 in std |
...
12. ~~**Using Crystal code.**~~ **Specified in III.6; the direct source mode
    ...
    **The Crystal ecosystem, and what a shard would cost.** Ten thousand
    ...
    Crystal's 8,161-line standard library against iyi's own 17,489-line prelude.
