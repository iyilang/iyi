...
check), TypeNode inspection in macros, and codegen beyond fun, struct, class, virtual dispatch, nilable, and block inlining slices
(full proc closures, exceptions, generics, and the GC interface). That is the
