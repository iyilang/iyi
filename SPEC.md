...
| compiler | 111,125 lines, none of it written in iyi |
...
|---|---|---|
| Compiler | 24,984 lines, **written in Crystal** | 111,125 lines, Crystal, forked |
| Library | 8,161 lines (3,551 of it core) | 14,217-line own prelude + 37,186 in std |
