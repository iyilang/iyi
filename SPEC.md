...
| iyi's own prelude | 14,132 lines, of which 3,734 are the library held to the 3,734 ceiling; the rest is the collector, the scheduler and the float printer, which 0.1.0's prelude got from libgc, pthreads and libc |
| compiler | 110,760 lines, none of it written in iyi |
...
> "No standard library worth the name" is still true of iyi's own 14,132 lines
...
**3. A deliberately tiny prelude, written in iyi. Done: 14,132 lines,
...
**3,734 lines** of the 14,132, measured by `bench/doc_numbers.py` as
...
|---|---|---|
| Compiler | 24,984 lines, **written in Crystal** | 110,760 lines, Crystal, forked |
| Library | 8,161 lines (3,551 of it core) | 14,132-line own prelude + 6,389 in std |
| Specs | 21,146 lines | 10,149 for iyi |
...
12. ~~**Using Crystal code.**~~ **Specified in III.6; the direct source mode
    ...
    **The Crystal ecosystem, and what a shard would cost.** Ten thousand
    ...
    Crystal's 8,161-line standard library against iyi's own 14,132-line prelude.
