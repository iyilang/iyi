...
| iyi's own prelude | 15,397 lines, of which 3,196 are the library held to the 3,734 ceiling (4,341 with every platform's floor, which the ceiling stopped counting after Windows); the rest is the collector, the scheduler and the float printer, which 0.1.0's prelude got from libgc, pthreads and libc |
| compiler | 112,511 lines, none of it written in iyi |
...
> "No standard library worth the name" is still true of iyi's own 15,397 lines
...
**3. A deliberately tiny prelude, written in iyi. Done: 15,397 lines,
primitives included, of which the library is 3,196.** Not a standard library:
...
**3,196 lines** of the 15,411, measured by `bench/doc_numbers.py` as
...
below settles and explains. Opening `src/iyi/` counts 4,341 with the floor
...
|---|---|---|
| Compiler | 24,984 lines, **written in Crystal** | 112,511 lines, Crystal, forked |
| Library | 8,161 lines (3,551 of it core) | 15,397-line own prelude + 38,917 in std |
...
12. ~~**Using Crystal code.**~~ **Specified in III.6; the direct source mode
    ...
    **The Crystal ecosystem, and what a shard would cost.** Ten thousand
    ...
    Crystal's 8,161-line standard library against iyi's own 15,397-line prelude.
