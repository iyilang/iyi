...
it uses, and iyi's own library is 14,420 lines rather than 8,161. The whole
...
iyi's own 562 KB prelude, the 1,176 KB of `src/std` that `import std/...`
...
program *has*: 8,161 lines of Crystal's standard library instead of 14,420
...
- **iyi's own library is 14,420 lines, and its IO is `puts`, `print`, the
...
| [`src/iyi`](src/iyi) | iyi's own library, 14,420 lines. `--crystal` swaps it for Crystal's |
