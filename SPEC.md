...
| compiler | 115,362 lines, none of it written in iyi |
...
|---|---|---|
| Compiler | 24,984 lines, **written in Crystal** | 115,362 lines, Crystal, forked |
| Library | 8,161 lines (3,551 of it core) | 16,192-line own prelude + 39,298 in std |
