...
it uses, and iyi's own library is 14,125 lines rather than 8,161. The whole
...
program *has*: 8,161 lines of Crystal's standard library instead of 14,125
...
| [`src/iyi`](src/iyi) | iyi's own library, 14,125 lines. `--crystal` swaps it for Crystal's |
