...
| iyi's own prelude | 17,472 lines, of which 3,494 are the library held to the 3,734 ceiling (5,015 with every platform's floor, which the ceiling stopped counting after Windows); the rest is the collector, the scheduler and the float printer, which 0.1.0's prelude got from libgc, pthreads and libc |
...
> "No standard library worth the name" is still true of iyi's own 17,472 lines
...
**3. A deliberately tiny prelude, written in iyi. Done: 17,472 lines,
...
| Library | 8,161 lines (3,551 of it core) | 17,472-line own prelude + 40,650 in std |
...
12. ~~**Using Crystal code.**~~ **Specified in III.6; the direct source mode
    ...
    **The Crystal ecosystem, and what a shard would cost.** Ten thousand
    ...
    Crystal's 8,161-line standard library against iyi's own 17,472-line prelude.
