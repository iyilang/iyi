...
| iyi's own prelude | 17,370 lines, of which 3,494 are the library held to the 3,734 ceiling (5,015 with every platform's floor, which the ceiling stopped counting after Windows); the rest is the collector, the scheduler and the float printer, which 0.1.0's prelude got from libgc, pthreads and libc |
...
> "No standard library worth the name" is still true of iyi's own 17,370 lines
...
**3. A deliberately tiny prelude, written in iyi. Done: 17,370 lines,
...
**3,494 lines** of the 17,370, measured by `bench/doc_numbers.py` as
...
| Library | 8,161 lines (3,551 of it core) | 17,370-line own prelude + 40,441 in std |
...
12. ~~**Using Crystal code.**~~ **Specified in III.6; the direct source mode
    ...
    **The Crystal ecosystem, and what a shard would cost.** Ten thousand
    ...
    Crystal's 8,161-line standard library against iyi's own 17,370-line prelude.
