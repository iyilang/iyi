...
it uses, and iyi's own library is 17,487 lines rather than 8,161. The whole
...
program *has*: 8,161 lines of Crystal's standard library instead of 17,487
...
- **iyi's own library is 17,487 lines, and its IO is `puts`, `print`, the
...
| [`src/iyi`](src/iyi) | iyi's own library, 17,487 lines. `--crystal` swaps it for Crystal's |
