...
| compiler | 110,901 lines, none of it written in iyi |
...
|---|---|---|
| Compiler | 24,984 lines, **written in Crystal** | 110,901 lines, Crystal, forked |
| Library | 8,161 lines (3,551 of it core) | 14,135-line own prelude + 30,128 in std |
