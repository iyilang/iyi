...
| compiler | 110,919 lines, none of it written in iyi |
...
|---|---|---|
| Compiler | 24,984 lines, **written in Crystal** | 110,919 lines, Crystal, forked |
| Library | 8,161 lines (3,551 of it core) | 14,208-line own prelude + 37,181 in std |
