...
> "No standard library worth the name" is still true of iyi's own 17,582 lines
...
**3. A deliberately tiny prelude, written in iyi. Done: 17,582 lines,
...
12. ~~**Using Crystal code.**~~ **Specified in III.6; the direct source mode
    ...
    **The Crystal ecosystem, and what a shard would cost.** Ten thousand
    ...
    Crystal's 8,161-line standard library against iyi's own 17,582-line prelude.
