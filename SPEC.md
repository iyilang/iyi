...
| iyi's own prelude | 15,658 lines, of which 3,219 are the library held to the 3,734 ceiling (4,602 with every platform's floor, which the ceiling stopped counting after Windows); the rest is the collector, the scheduler and the float printer, which 0.1.0's prelude got from libgc, pthreads and libc |
...
> "No standard library worth the name" is still true of iyi's own 15,658 lines
...
**3. A deliberately tiny prelude, written in iyi. Done: 15,658 lines,
...
**3,219 lines** of the 15,658, measured by `bench/doc_numbers.py` as
...
below settles and explains. Opening `src/iyi/` counts 4,602 with the floor
...
**And it was breached again by Windows' own floor — 4,602 of 3,734, 868
...
where most of the 868 lines are.
...
of the 4,602, and Windows is the largest arm of it by a wide margin, which
...
The rewrite means the library gives back 868 lines, which at this size
...
| Library | 8,161 lines (3,551 of it core) | 15,658-line own prelude + 38,986 in std |
...
12. ~~**Using Crystal code.**~~ **Specified in III.6; the direct source mode
    ...
    **The Crystal ecosystem, and what a shard would cost.** Ten thousand
    ...
    Crystal's 8,161-line standard library against iyi's own 15,658-line prelude.
