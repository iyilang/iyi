...
| iyi's own prelude | 14,409 lines, of which 3,841 are the library held to the 3,841 ceiling; the rest is the collector, the scheduler and the float printer, which 0.1.0's prelude got from libgc, pthreads and libc |
| compiler | 111,169 lines, none of it written in iyi |
...
> "No standard library worth the name" is still true of iyi's own 14,409 lines
...
**3. A deliberately tiny prelude, written in iyi. Done: 14,409 lines,
...
**3,841 lines** of the 14,409, measured by `bench/doc_numbers.py` as
...
|---|---|---|
| Compiler | 24,984 lines, **written in Crystal** | 111,169 lines, Crystal, forked |
| Library | 8,161 lines (3,551 of it core) | 14,409-line own prelude + 37,522 in std |
| Specs | 21,146 lines | 10,242 for iyi |
...
12. ~~**Using Crystal code.**~~ **Specified in III.6; the direct source mode
    ...
    **The Crystal ecosystem, and what a shard would cost.** Ten thousand
    ...
    Crystal's 8,161-line standard library against iyi's own 14,409-line prelude.
