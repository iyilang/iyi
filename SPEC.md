...
| compiler | 115,416 lines, none of it written in iyi |
...
|---|---|---|
| Compiler | 24,984 lines, **written in Crystal** | 115,416 lines, Crystal, forked |
| Library | 8,161 lines (3,551 of it core) | 17,290-line own prelude + 39,751 in std |
