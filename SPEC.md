...
| compiler | 110,800 lines, none of it written in iyi |
...
|---|---|---|
| Compiler | 24,984 lines, **written in Crystal** | 110,800 lines, Crystal, forked |
| Library | 8,161 lines (3,551 of it core) | 14,135-line own prelude + 26,000 in std |
| Specs | 21,146 lines | 10,219 for iyi |
