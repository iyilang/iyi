...
| iyi's own prelude | 16,192 lines, of which 3,443 are the library held to the 3,734 ceiling (4,951 with every platform's floor, which the ceiling stopped counting after Windows); the rest is the collector, the scheduler and the float printer, which 0.1.0's prelude got from libgc, pthreads and libc |
| compiler | 115,357 lines, none of it written in iyi |
...
> "No standard library worth the name" is still true of iyi's own 16,192 lines
...
**3. A deliberately tiny prelude, written in iyi. Done: 16,192 lines,
primitives included, of which the library is 3,443.** Not a standard library:
...
**3,443 lines** of the 16,192, measured by `bench/doc_numbers.py` as
...
below settles and explains. Opening `src/iyi/` counts 4,951 with the floor
...
exists for the same reason — the platform floor measures **1,508 lines**
...
and the library is **3,443** of 3,734 with 291 to spare.
...
|---|---|---|
| Compiler | 24,984 lines, **written in Crystal** | 115,357 lines, Crystal, forked |
| Library | 8,161 lines (3,551 of it core) | 16,192-line own prelude + 39,210 in std |
| Specs | 21,146 lines | 11,920 for iyi |
...
12. ~~**Using Crystal code.**~~ **Specified in III.6; the direct source mode
    ...
    **The Crystal ecosystem, and what a shard would cost.** Ten thousand
    ...
    Crystal's 8,161-line standard library against iyi's own 16,192-line prelude.
