...
| compiler | 118,011 lines, none of it written in iyi |
...
> "No standard library worth the name" is still true of iyi's own 17,838 lines
...
**3. A deliberately tiny prelude, written in iyi. Done: 17,838 lines,
...
below settles and explains. Opening `src/iyi/` counts 5,046 with the floor
...
exists for the same reason — the platform floor measures **1,537 lines**
...
|---|---|---|
| Compiler | 24,984 lines, **written in Crystal** | 118,011 lines, Crystal, forked |
...
12. ~~**Using Crystal code.**~~ **Specified in III.6; the direct source mode
    ...
    **The Crystal ecosystem, and what a shard would cost.** Ten thousand
    ...
    Crystal's 8,161-line standard library against iyi's own 17,838-line prelude.
