...
| compiler | 113,323 lines, none of it written in iyi |
...
|---|---|---|
| Compiler | 24,984 lines, **written in Crystal** | 113,323 lines, Crystal, forked |
| Library | 8,161 lines (3,551 of it core) | 15,697-line own prelude + 38,983 in std |
| Specs | 21,146 lines | 11,401 for iyi |
